...
from src.Python.eMaze_App_TOM.Doors.DoorControl import DoorControl
from src.Python.eMaze_App_TOM.MainLoop.MainLoop import MainLoop  # Line to choose the logic: from (insert logic name) import MainLoop
from src.Python.eMaze_App_TOM.Settings import Settings
from src.Python.eMaze_App_TOM.Zones.Zones import Zones
