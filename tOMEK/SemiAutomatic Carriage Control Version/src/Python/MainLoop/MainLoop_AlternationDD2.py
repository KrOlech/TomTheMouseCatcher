...
class MainLoop(BaseMainLoop):
    """Alternation DD2: L1 reward 100%, L2 reward 25%; D4 blocks first 25 trials."""
    ...
    def _set_center_doors_dd2(self):
        self._closeDoors(["D1", "D2"])
        self._openDoors(["D3", "D5", "D6"])
        if self.counter < self.FORCED_TRIALS:
            self.CloseDoor("D4")
        else:
            self.OpenDoor("D4")
