...
class EMaze(EMazeNoDoors):
    ...
    def __init__(self):
        ...
        # IMPORTANT: keyboard hook runs in a THREAD of the main process.
        # On Windows this is more reliable than pynput inside a child process.
    ...
    def run(self):
        self.p.start()                      # camera, recording, mouse localisation
        self.dc.start()                     # doors, lights and rewards
        self.keyboard_motor_thread.start()  # manual motor control on COM3
